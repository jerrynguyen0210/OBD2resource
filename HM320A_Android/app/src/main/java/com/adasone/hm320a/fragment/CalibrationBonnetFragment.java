 ...
 */
public class CalibrationBonnetFragment extends Fragment implements ZoomView.ZoomViewListener{
    private static final String TAG = CalibrationBonnetFragment.class.getSimpleName();
    public static final String FRAGMENT_TAG = CalibrationBonnetFragment.class.getSimpleName();
    ...
    public CalibrationBonnetFragment() {
        // Required empty public constructor
    }

    public static CalibrationBonnetFragment newInstance() {
        return new CalibrationBonnetFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_calibration_bonnet, container, false);
            ...
            switch (view.getId()) {
                case R.id.btn_ok :
                    if (mListener != null ) {
                        ...
                        mListener.onMenuSelected(Constants.Menu.CALIBRATION_VANISH, 0);
                    }
                    break;
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<CalibrationBonnetFragment> mFragment;
        private MyHandler(CalibrationBonnetFragment fragment) {
            mFragment = new WeakReference<CalibrationBonnetFragment>(fragment);
        }
        @Override
        public void handleMessage(Message msg) {
            final CalibrationBonnetFragment fragment = mFragment.get();
            switch (msg.what) {
                default :
                    break;
            }
