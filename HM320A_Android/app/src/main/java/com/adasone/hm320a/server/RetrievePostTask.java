 ...
 */
public class RetrievePostTask extends AsyncTask<String, Void, AsyncTaskResult<JSONObject>> {

	private static final String TAG = RetrievePostTask.class.getSimpleName();

    private static final int CONN_TIMEOUT = 30000;
    private static final int READ_TIMEOUT = 30000;
    private final AsyncTaskListener mListener;

	public RetrievePostTask(AsyncTaskListener listener) {
        mListener = listener;
	}
