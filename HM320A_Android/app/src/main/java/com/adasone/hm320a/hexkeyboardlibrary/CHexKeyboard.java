...
public class CHexKeyboard {
            ...
            if (focusCurrent != null && focusCurrent.getClass() == EditText.class) {
                ...
                switch (primaryCode) {
                    ...
                    case CodeCancel /*-3*/:
                        ...
                        return;
                    case CodePrev /*55000*/:
                        focusNew = edittext.focusSearch(View.FOCUS_DOWN); // check again
                        if (focusNew != null) {
                    ...
                    case CodeAllRight /*55004*/:
                        ...
                        return;
                    case CodeNext /*55005*/:
                        focusNew = edittext.focusSearch(View.FOCUS_UP);
                        if (focusNew == null) {
                            CHexKeyboard.this.hideCustomKeyboard();
                            return;
    ...
    public void showCustomKeyboard(View v) {
        ...
        if (v != null) {
            ((InputMethodManager) this.mHostActivity.getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(v.getWindowToken(), 0);
        }
    }
