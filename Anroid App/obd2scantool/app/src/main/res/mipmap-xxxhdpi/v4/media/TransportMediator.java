...
public class TransportMediator extends TransportController {
    ...
    class C00352 implements Callback {
        C00352() {
        }
    ...
    class C03021 implements TransportMediatorCallback {
        C03021() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C03021();
        this.mKeyEventCallback = new C00352();
