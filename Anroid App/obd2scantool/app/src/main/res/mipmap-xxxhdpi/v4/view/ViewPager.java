...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00681();
    ...
    private static final Interpolator sInterpolator = new C00692();
    ...
    private final Runnable mEndScrollRunnable = new C00703();
    ...
    static class C00681 implements Comparator<ItemInfo> {
        C00681() {
        }
    ...
    static class C00692 implements Interpolator {
        C00692() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03121());
        ...
        switch (ev.getAction() & 255) {
            ...
            case 1:
                if (this.mIsBeingDragged) {
                    ...
                    velocityTracker.computeCurrentVelocity(CAdapter.USB_SEND_MAX_TIMEOUT, (float) this.mMaximumVelocity);
