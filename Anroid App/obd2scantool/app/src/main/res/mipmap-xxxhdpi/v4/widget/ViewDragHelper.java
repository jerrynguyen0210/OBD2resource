...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01041();
    ...
    private final Runnable mSetIdleRunnable = new C01052();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    /* renamed from: android.support.v4.widget.ViewDragHelper$1 */
    static class C01041 implements Interpolator {
        C01041() {
        }
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(CAdapter.USB_SEND_MAX_TIMEOUT, this.mMaxVelocity);
