            ...
            switch (action & 255) {
                ...
                case 1:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        velocityTracker.computeCurrentVelocity(CAdapter.USB_SEND_MAX_TIMEOUT, (float) this.mMaximumFlingVelocity);
                ...
                case 6:
                    ...
                    this.mLastFocusY = focusY;
                    this.mDownFocusY = focusY;
                    this.mVelocityTracker.computeCurrentVelocity(CAdapter.USB_SEND_MAX_TIMEOUT, (float) this.mMaximumFlingVelocity);
