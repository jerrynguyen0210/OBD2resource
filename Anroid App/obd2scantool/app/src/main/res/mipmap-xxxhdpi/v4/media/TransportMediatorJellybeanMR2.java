...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00394();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00383();
    ...
    final OnWindowAttachListener mWindowAttachListener = new C00361();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00372();

    /* renamed from: android.support.v4.media.TransportMediatorJellybeanMR2$1 */
    class C00361 implements OnWindowAttachListener {
        C00361() {
        }
    ...
    class C00372 implements OnWindowFocusChangeListener {
        C00372() {
        }
    ...
    class C00383 extends BroadcastReceiver {
        C00383() {
        }
    ...
    class C00394 implements OnAudioFocusChangeListener {
        C00394() {
        }
