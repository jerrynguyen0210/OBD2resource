...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00271();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C03002();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C00271 implements ThreadFactory {
    ...
    class C03002 extends WorkerRunnable<Params, Result> {
        C03002() {
            super();
        }
