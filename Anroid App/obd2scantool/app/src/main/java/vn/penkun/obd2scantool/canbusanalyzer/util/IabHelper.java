//package vn.penkun.obd2scantool.canbusanalyzer.util;
//
...
//        serviceIntent.setPackage(zze.GOOGLE_PLAY_STORE_PACKAGE);
...
//    }
//
//    public void consumeByToken(String token) {
//        if (token != null) {
//            try {
//                this.mService.consumePurchase(3, this.mContext.getPackageName(), token);
//            } catch (Exception e) {
//            }
//        }
//    }
//
//    public void consumeByTokenAsync(final String token) {
//        new Thread(new Runnable() {
//            public void run() {
//                IabHelper.this.consumeByToken(token);
//            }
//        }).start();
//    }
//
...
//        return sku.equals("android.test.purchased") || sku.equals("android.test.canceled") || sku.equals("android.test.refunded") || sku.equals("android.test.item_unavailable");
//    }
//
...
//                        isVerified = true;
//                    } else {
//                        isVerified = Security.verifyPurchase(this.mSignatureBase64, purchaseData, signature);
//                    }
//                    if (isVerified) {
...
//        i$ = packs.iterator();
//        while (i$.hasNext()) {
//            ArrayList<String> skuPartList = (ArrayList) i$.next();
...
//                while (i$2.hasNext()) {
//                    SkuDetails d = new SkuDetails(itemType, (String) i$2.next());
