...
import vn.penkun.obd2scantool.canbusanalyzer.CDatHolder.CDatTable;
...
public class CAdapter {
    public static final String ACTION_LOG_STR = "com.yatrim.canbusanalyzer.CADAPTER_LOG_STR";
    public static final String ACTION_USB_PERMISSION = "com.yatrim.canbusanalyzer.USB_PERMISSION";
    ...
    public void check() {
        ...
        showMessage(C0280R.string.str_msg_adapter_not_connected);
    }
